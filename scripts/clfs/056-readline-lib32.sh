...
build2 "mv -v /lib/lib{readline,history}.a /usr/lib" $_log
build2 "ln -svf ../../lib/\$(readlink /lib/libreadline.so) /usr/lib/libreadline.so" $_log

build2 "ln -svf ../../lib/\$(readlink /lib/libhistory.so) /usr/lib/libhistory.so" $_log
build2 "rm -v /lib/lib{readline,history}.so" $_log
